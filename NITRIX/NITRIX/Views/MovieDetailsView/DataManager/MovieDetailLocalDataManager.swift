...
final class MovieDetailLocalDataManager {
    ...
    private func addMovie(
        ...
        failure: @escaping ((CoreDataErrors) -> ())) {
            ...
            let newMovie = NSEntityDescription.insertNewObject(
                forEntityName: Constants.Managers.CoreData.favoriteMovieEntityName,
                into: managedObjectContext) as! CDFavorite
